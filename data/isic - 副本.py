...
if __name__ == '__main__':
    ...
    dataset = DatasetISIC(datapath="../datasets/isic2018-classwise",fold=0,transform=transform,split='trn',shot=5)
    print(len(dataset))
    print(dataset[3])
    # path ='../datasets/isic2018-classwise\\ISIC2018_Task1-2_Training_Input\\1\\ISIC_0000024.jpg'
    dataloader = DataLoader(dataset, batch_size=1, shuffle=0, num_workers=1,
                            pin_memory=True)
